...
std::string baseFx11Scene::getName()
{
	return sceneName;
}
HRESULT baseFx11Scene::initScene(ID3D11Device* pd3dDevice)
{
	isInit = true;
	HRESULT hr = S_OK;
	...
	WCHAR str[MAX_PATH];
	V_RETURN(DXUTFindDXSDKMediaFileCch(str, MAX_PATH, L"shader//basefx11.fx"));
	...
	g_ptxEnvVariable = g_pEffect->GetVariableByName("g_EnvCube")->AsShaderResource();
...
HRESULT CALLBACK baseFx11Scene::OnD3D11CreateDevice(ID3D11Device* pd3dDevice, const DXGI_SURFACE_DESC* pBackBufferSurfaceDesc,
	void* pUserContext)
{
...
HRESULT CALLBACK baseFx11Scene::OnD3D11ResizedSwapChain(ID3D11Device* pd3dDevice, IDXGISwapChain* pSwapChain,
...
void CALLBACK baseFx11Scene::OnD3D11FrameRender(ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dImmediateContext,
...
void CALLBACK baseFx11Scene::OnD3D11DestroyDevice(void* pUserContext)
{
...
LRESULT CALLBACK baseFx11Scene::MsgProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam,
...
void CALLBACK baseFx11Scene::OnFrameMove(double fTime, float fElapsedTime, void* pUserContext)
{
